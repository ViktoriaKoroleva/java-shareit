...
import ru.practicum.shareit.exception.NotFoundExceptions;
...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto saveItem(String owner, ItemDto itemDto) {
        ...
        User user = userRepository.findById(ownerId)
                .orElseThrow(() -> new NotFoundExceptions("Пользователь с id = " + ownerId + " не найден"));
        ...
        if (requestId != null) {
            itemRequest = itemRequestRepository.findById(requestId)
                    .orElseThrow(() -> new NotFoundExceptions("ItemRequest id = " + requestId + " not found!"));
        }
    ...
    public ItemDto updateItem(String owner, ItemDto itemDto) {
        ...
        if (itemDto.getId() == null) {
            throw new NotFoundExceptions("Не передан идентификатор Вещи для обновления");
        }
        Item returnedItem = itemRepository.findById(itemDto.getId())
                .orElseThrow(() -> new NotFoundExceptions("Вещь с id " + itemDto.getId() + " не найдена"));
    ...
    public ItemInfoDto getItem(String owner, long itemId) {
        ...
        Item returnedItem = itemRepository.findById(itemId)
                .orElseThrow(() -> new NotFoundExceptions("Вещь с id " + itemId + " не найдена"));
    ...
    public CommentDto addComment(Long userId, Long itemId, CommentDto commentDto) {
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new NotFoundExceptions("Пользователь с id " + userId + " не найдена"));
